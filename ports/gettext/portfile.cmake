if(VCPKG_TARGET_IS_LINUX)
    ...
    if(NOT "autopoint" IN_LIST FEATURES)
        return()
    elseif ("tools" IN_LIST FEATURES)
        if(NOT EXISTS "/usr/bin/autopoint")
            message(FATAL_ERROR "Please use command \"sudo apt-get install gettext autopoint\" to install gettext tools on linux.")
        endif()
        return()
    endif()
else()
...
elseif("autopoint" IN_LIST FEATURES)
    # A fast installation of the autopoint tool and data
    set(VCPKG_POLICY_EMPTY_PACKAGE enabled)
