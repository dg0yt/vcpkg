...
if(VCPKG_TARGET_IS_WINDOWS AND NOT X_VCPKG_TARGET_IS_MINGW)
    file(GLOB def_files "${CMAKE_CURRENT_LIST_DIR}/*.def")
    file(COPY ${def_files} DESTINATION "${SOURCE_PATH}")
    vcpkg_list(APPEND OPTIONS "MSVC_STYLE=yes" "VCPKG_TARGET_ARCHITECTURE=${VCPKG_TARGET_ARCHITECTURE}")
else()
    vcpkg_list(APPEND OPTIONS "MSVC_STYLE=no")
endif()
