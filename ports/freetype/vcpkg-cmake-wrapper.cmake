if(CMAKE_VERSION VERSION_LESS 3.7 AND CMAKE_BUILD_TYPE STREQUAL "Debug")
    find_library(FREETYPE_LIBRARY NAMES freetyped PATHS "${_VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET}/debug/lib" NO_DEFAULT_PATH)
endif()
_find_package(${ARGS})
