...
file(GLOB _vcpkg_wx_configs LIST_DIRECTORIES false "${wxWidgets_LIB_DIR}/wx/config/*")
if(_vcpkg_wx_configs)
    list(GET _vcpkg_wx_configs 0 wxWidgets_CONFIG_EXECUTABLE)
endif()
#[[
