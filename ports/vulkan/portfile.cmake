...
if(DETECTED_Vulkan_FOUND)
    ...
    elseif(VCPKG_TARGET_IS_LINUX)
        string(APPEND message "Refer to Getting Started with the Linux Tarball Vulkan SDK: https://vulkan.lunarg.com/doc/sdk/latest/linux/getting_started.html")
    else()
        string(APPEND message "Please set environment variable VULKAN_SDK.")
    endif()
